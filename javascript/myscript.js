...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tim của tui đang đập nhanh " + (thePercent+899) + " (ấn vào đây nè) ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-body').innerHTML = 'Nãy lên huyết áp do thấy m cười =)) <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc bạn có thể liên hệ<a href='https://www.facebook.com/profile.php?id=100030964275189'>Quốc Bảo<a>";
